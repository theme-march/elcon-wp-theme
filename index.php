                            ...
                            <li class="d-flex align-items-center">
                                <div class="posts-thumb">
                                    <a href="#"><img loading="lazy" alt="img"
                                            src="<?php echo get_template_directory_uri();?>/images/news/news1.jpg"></a>
                                </div>
                                <div class="post-info">
                ...
                <div class="post">
                    ...
                    <div class="post-body">
                        <div class="entry-header">
                            ...
                            <h2 class="entry-title">
                                <a href="news-single.html">Thandler Airport Water Reclamation Facility Expansion Project
                                    Named</a>
                            </h2>
                        </div><!-- header end -->
                ...
                <div class="post">
                    ...
                    <div class="post-body">
                        <div class="entry-header">
                            ...
                            <h2 class="entry-title">
                                <a href="news-single.html">Silicon Bench and Cornike Begin Construction of Large-Scale
                                    Solar Facilities
                                    for Trade</a>
                            </h2>
                        </div><!-- header end -->
